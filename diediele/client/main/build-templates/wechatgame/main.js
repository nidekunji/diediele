(function () {
    ...
    function boot () {
        ...
        var onStart = function () {
            var loadingScene = require('src/loading-scene.0766b');
        ...
        if (!false) {
            var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.d4e5f.js';
            if (jsList) {
    ...
    if (true) {
        require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.edf07.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.edf07.js';
