 ...
 * @time 2020.5.25
 */
const {GAME_STATE, GAME_EVENTS, ERRORS} = require('../Utils/Constants');
...
cc.Class({
    ...
    load() {
        ...
        return Service.fetchLevelCode(this.level).then(function(lvlcode) {
            ...
            .then(function(resources) {
                ...
                //cc.log(JSON.stringify(self.staticFigures));
            ...
            .then(() => {
                return window.themeManager.loadResDir("preuse dynamic figures")
                    .then(function(resources) {
                        ...
                        //cc.log(JSON.stringify(self.dynamicFigures));
    ...
    onLoad () {
        ...
        this.LISTCHARS = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";//这是什么？
        this.LVLCODE = "";
    },
    ...
    nextLevel () {
        this.level++;
        Service.startGame({level: this.level})
        .then(res => {
